...
public class UserAdminController {
    ...
    @PostMapping("/info")
    public ResponseEntity<ApiResponse<Map<String, Object>>> getUserAuthInfo(@RequestBody Map<String, String> request) {
        try {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> updateRole(@RequestBody Map<String, Object> request) {
        try {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> deleteRole(@RequestBody Map<String, String> request) {
        try {
            String userid = request.get("userid");
            if (userid == null || userid.trim().isEmpty()) {
                return ResponseEntity.badRequest()
