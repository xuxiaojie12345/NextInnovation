...
public class HdocVariablesController {
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> addVariable(@RequestBody Map<String, String> request) {
        try {
            ...
            if (result > 0) {
                ...
                return ResponseEntity.status(500)
                    .body(ApiResponse.error(500, "Failed to add variable."));
            }
        } catch (Exception e) {
            return ResponseEntity.status(500)
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> updateVariable(@RequestBody Map<String, String> request) {
        try {
            String variable = request.get("variable");
            String type = request.get("type");
            String description = request.get("description");
            ...
            if (result > 0) {
                ...
                return ResponseEntity.status(404)
                    .body(ApiResponse.error(404, "Variable not found."));
            }
        } catch (Exception e) {
            return ResponseEntity.status(500)
                .body(ApiResponse.error(500, "System error. Please contact administrator."));
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> deleteVariable(@RequestBody Map<String, String> request) {
        try {
            String variable = request.get("variable");
            if (variable == null || variable.trim().isEmpty()) {
                return ResponseEntity.badRequest()
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> searchVariables(@RequestBody Map<String, String> request) {
        try {
            String variable = request.get("variable");
            ...
            List<Map<String, Object>> list = hdocVariablesService.searchVariables(
                variable, variableOp,
                type, typeOp,
    ...
    public ResponseEntity<?> exportVariables() {
        try {
            ...
            return ResponseEntity.status(500)
                .body(ApiResponse.error(500, "CSV导出失败"));
        }
    }
