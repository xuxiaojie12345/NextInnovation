...
public class UD15SendDataController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> viewInfo(@RequestBody Map<String, String> request) {
        try {
    ...
    public ResponseEntity<ApiResponse<Object>> setRegenerate(@RequestBody Map<String, String> request) {
        try {
            String serie = request.get("serie");
            String chnr = request.get("chnr");
    ...
    public ResponseEntity<ApiResponse<Object>> changeToBasicInfo(@RequestBody Map<String, String> request) {
        try {
            String serie = request.get("serie");
            String chnr = request.get("chnr");
    ...
    public ResponseEntity<ApiResponse<Object>> changeToAdvancedInfo(@RequestBody Map<String, String> request) {
        try {
            String serie = request.get("serie");
            String chnr = request.get("chnr");
