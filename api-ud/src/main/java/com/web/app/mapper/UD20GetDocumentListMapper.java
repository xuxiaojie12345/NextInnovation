...
public interface UD20GetDocumentListMapper {
     ...
     * 支持按 doctype（模糊）、registerUser、registerDatetime 动态条件查询
     *
     * @param request 查询请求参数（包含字段值和运算符）
     * @return 文档数据列表
     */
    List<UD20GetDocumentListResponse.DocumentData> selectDocumentList(UD20GetDocumentListRequest request);
}
