...
public class UD08HomologationVariablesServiceImpl implements UD08HomologationVariablesService {
    ...
    @Override
    public List<Map<String, Object>> searchRules(String pc, String num, String market, String variable, String val,
        ...
        return mapper.searchRules(pc, num, market, variable, val,
    ...
    public int deleteSelectedRules(List<Map<String, Object>> records) {
        List<UD08HomologationVariablesMapper.RuleKey> keys = records.stream().map(r -> {
            UD08HomologationVariablesMapper.RuleKey k = new UD08HomologationVariablesMapper.RuleKey();
