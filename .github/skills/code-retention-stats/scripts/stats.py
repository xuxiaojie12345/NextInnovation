...
def is_src_file(fpath):
    """判断文件路径是否属于 api-ud/src/main 或 react-ud/src/"""
    return fpath.startswith("api-ud/src/main") or fpath.startswith("react-ud/src/")
...
def main():
    ...
    hc_path = output_dir / f"high_churn_files_{ts}.txt"
    ...
    dev_path = output_dir / f"dev_retention_details_{ts}.txt"
    ...
    html_path = output_dir / f"adoption_report_{ts}.html"
