...
- Name: UD03_GenerateHomologationDocument.spec.ts >> Generate Homologation Document 模块 (UD03) 测试 >> [7] Chassis no-半角数字のみ
- Location: src\tests\UD03_GenerateHomologationDocument.spec.ts:69:7
