...
- Name: UD03_GenerateHomologationDocument.spec.ts >> Generate Homologation Document 模块 (UD03) 测试 >> [5] Chassis series-半角英数字のみ
- Location: src\tests\UD03_GenerateHomologationDocument.spec.ts:52:7
