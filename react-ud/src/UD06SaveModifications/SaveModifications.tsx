  ...
  const fetchModificationData = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_API_BASE_URL}/api/UD06/saveModifications?chassisSerie=${encodeURIComponent(chassisSerieParam)}&chassisNumber=${encodeURIComponent(chassisNumberParam)}`,
        {
          method: "GET",
          headers: {
    ...
    <div className='sm-container'>
      ...
      <div className='sm-border-box'>
        ...
        <div className='sm-button-bar'>
          <button type='button' onClick={handleClose} className='sm-close-btn'>
            Close
          </button>
        </div>
      </div>
